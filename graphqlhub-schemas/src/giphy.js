...
let imageDataTypes = {
  fixed_height: makeImageType("FixedHeight", [
    "url",
    "width",
    "height",
    "size",
  ...
  fixed_height_still: makeImageType("FixedHeightStill", [
    "url",
    "width",
    "height"
  ]),
  fixed_height_downsampled: makeImageType("FixedHeightDownsample", [
    "url",
    "width",
    "height",
    "size",
  ...
  fixed_width: makeImageType("FixedWidth", [
    "url",
    "width",
    "height",
    "size",
  ...
  fixed_width_still: makeImageType("FixedWidthStill", [
    "url",
    "width",
    "height"
  ]),
  fixed_width_downsampled: makeImageType("FixedWidthDownsample", [
    "url",
    "width",
    "height",
    "size",
  ...
  fixed_height_small: makeImageType("FixedHeightSmall", [
    "url",
    "width",
    "height",
    "size",
  ...
  fixed_height_small_still: makeImageType("FixedHeightSmallStill", [
    "url",
    "width",
    "height"
  ]),
  fixed_width_small: makeImageType("FixedWidthSmall", [
    "url",
    "width",
    "height",
    "size",
  ...
  fixed_width_small_still: makeImageType("FixedWidthSmallStill", [
    "url",
    "width",
    "height"
  ]),
  ...
  downsized_large: makeImageType("DownsizedLarge", [
    "url",
    "width",
    "height",
    "size"
  ]),
  original: makeImageType("Original", [
    "url",
    "width",
    "height",
    "size",
...
let transformRandom = randomData => {
  ...
  let imageData = {
    ...
    fixed_height_downsampled: takeKeysWithPrefix(
      "fixed_height_downsampled_",
      randomData
    ),
    fixed_width_downsampled: takeKeysWithPrefix(
      "fixed_width_downsampled_",
      randomData
    ),
