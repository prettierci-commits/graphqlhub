            ...
            injectDOMPropertyConfig: function(domPropertyConfig) {
              ...
              for (var propName in Properties) {
                ...
                var propertyInfo = {
                  ...
                  mustUseAttribute: checkMask(
                    propConfig,
                    Injection.MUST_USE_ATTRIBUTE
                  ),
            ...
            getDOMNode: function() {
              "development" !== "production"
                ? warning(
                    ...
                    ReactInstanceMap.get(this).getName() ||
                      this.tagName ||
                      "Unknown"
                  )
                : undefined;
            ...
            mountComponent: function(rootID, transaction, context) {
              ...
              switch (this._tag) {
                ...
                case "select":
                  ...
                  context = ReactDOMSelect.processChildContext(
                    this,
                    props,
                    context
                  );
              ...
              if ("development" !== "production") {
                ...
                this._processedContextDev = processChildContextDev(
                  context,
                  this
                );
              ...
              switch (this._tag) {
                case "input":
                  transaction
                    .getReactMountReady()
                    .enqueue(mountReadyInputWrapper, this);
                // falls through
                case "button":
                case "select":
                case "textarea":
        ...
        function(_dereq_, module, exports) {
          ...
          var ReactDefaultPerf = {
            ...
            printExclusive: function(measurements) {
              ...
              var summary = ReactDefaultPerfAnalysis.getExclusiveSummary(
                measurements
              );
              console.table(
            ...
            printDOM: function(measurements) {
              measurements = measurements || ReactDefaultPerf._allMeasurements;
              var summary = ReactDefaultPerfAnalysis.getDOMSummary(
                measurements
              );
              console.table(
                summary.map(function(item) {
            ...
            measure: function(moduleName, fnName, func) {
              return function() {
                ...
                if (
                  ...
                  if (
                    this._currentElement.type === ReactMount.TopLevelWrapper
                  ) {
        ...
        function(_dereq_, module, exports) {
          ...
          function findFirstReactDOMImpl(node) {
            ...
            for (; node && node.parentNode !== node; node = node.parentNode) {
              ...
              var reactRootID = ReactInstanceHandles.getReactRootIDFromNodeID(
                nodeID
              );
        ...
        function(_dereq_, module, exports) {
          ...
          function getComponentClassForElement(element) {
            ...
            if (componentClass == null) {
              tagToComponentClass[
                tag
              ] = componentClass = autoGenerateWrapperClass(tag);
            }
        ...
        function(_dereq_, module, exports) {
          ...
          var ReactUpdateQueue = {
            ...
            enqueueSetProps: function(publicInstance, partialProps) {
              ...
              ReactUpdateQueue.enqueueSetPropsInternal(
                internalInstance,
                partialProps
              );
            },
            ...
            enqueueSetPropsInternal: function(internalInstance, partialProps) {
              ...
              // element props.
              var wrapElement =
                topLevelWrapper._pendingElement ||
          ...
          function instantiateReactComponent(node) {
            ...
            if (node === null || node === false) {
              ...
              if (typeof element.type === "string") {
                instance = ReactNativeComponent.createInternalComponent(
                  element
                );
