!(function() {
  ...
  function i() {
    return (
      ...
      (this._initBody = function(a) {
        ...
        else if (h.blob && Blob.prototype.isPrototypeOf(a)) this._bodyBlob = a;
        else if (h.formData && FormData.prototype.isPrototypeOf(a))
  ...
  function l(a, b) {
    if (
      ...
      (this.method = k(b.method || "GET")),
      (this.mode = b.mode || null),
      (this.referrer = null),
      ("GET" === this.method || "HEAD" === this.method) && b.body)
    )
  ...
  function o(a, b) {
    b || (b = {}),
      ...
      (this.headers = b.headers instanceof c ? b.headers : new c(b.headers)),
      (this.url = b.url || "");
  }
  if (!self.fetch) {
    ...
    i.call(l.prototype),
      ...
      (self.fetch = function(a, b) {
        var c;
        return (
          (c = l.prototype.isPrototypeOf(a) && !b ? a : new l(a, b)),
          new Promise(function(a, b) {
            function e() {
              return "responseURL" in d
                ? d.responseURL
                : /^X-Request-URL:/m.test(d.getAllResponseHeaders())
                  ? d.getResponseHeader("X-Request-URL")
                  : void 0;
            }
            ...
            (d.onload = function() {
              ...
              if (100 > c || c > 599)
                return b(new TypeError("Network request failed")), void 0;
              var f = {
                  status: c,
              ...
              "responseType" in d && h.blob && (d.responseType = "blob"),
